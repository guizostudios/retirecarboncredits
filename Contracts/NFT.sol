...
contract RetireCarbonCredits is ERC721, ERC721Enumerable, ERC721URIStorage, ERC2981, Pausable, Ownable, ERC721Burnable {
    ...
    function safeMint(address _to, string memory _uri, string memory _name, string memory _methodology, 
    string memory _region, string memory _emissionType) public whenNotPaused onlyOwner {
    ...
    function burnToken (uint256 tokenID, string memory _retireMessage, uint256 _amount) public whenNotPaused{
        ...
        require (owner == msg.sender, "Only the owner can burn the NFT");
        _burn(tokenID);
    ...
    function ownerOf (uint256 tokenId) public view virtual override (ERC721, IERC721) returns (address){
        ...
        require (owner != address(0), "erc721 can't be zero");
        return owner;
    }
